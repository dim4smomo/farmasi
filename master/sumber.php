...
<head>
<meta charset="UTF-8">
<title>Sumber Obat - Dashboard Modern</title>
...
<body>
<div class="container">
  <h2>📑 Data Sumber Obat</h2>
  <div class="mb-3">
    <button class="btn btn-primary" id="btnTambah">➕ Tambah Sumber</button>
    <a href="../index.php" class="btn btn-secondary">⬅️ Kembali Dashboard</a>
  </div>
  <table id="tabelSumber" class="display table table-striped" style="width:100%">
    <thead>
      <tr>
        <th>No</th>
        <th>Nama Sumber</th>
...
<!-- Modal Add/Edit -->
<div class="modal fade" id="modalSumber" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalSumberTitle">Form Sumber</h5>
...
$(document).ready(function(){
  table = $('#tabelSumber').DataTable({
    "ajax": "sumber_table.php",
    "columns": [
  ...
  $("#btnTambah").click(function(){
    $("#modalSumberTitle").text("Tambah Sumber");
    $("#formContent").load("sumber_add.php", function(){
  ...
  $(document).on("click",".btnEdit",function(){
    var id = $(this).data("id");
    $("#modalSumberTitle").text("Edit Sumber");
    $("#formContent").load("sumber_edit.php?id_sumber="+id,function(){
      $("#modalSumber").modal("show");
    });
  });
  ...
  $("#btnConfirmDelete").click(function(){
    if(hapusId){
      $.post("sumber_delete.php",{id_sumber:hapusId}, function(res){
